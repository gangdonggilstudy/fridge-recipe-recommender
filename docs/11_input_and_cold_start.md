...
> 💡 왜 음식 카드? 사용자에게 "매운맛 0.8 좋아하세요?"라고 직접 물으면 어렵습니다. **"김치찌개 좋아요?"**가 훨씬 자연스럽고, 내부에서 (찌개, 매운맛) 차원으로 자동 변환합니다.
...
> 💡 모든 단계에 폴백: 날씨 키가 없거나 API가 실패해도 "맑음"으로 안전하게 떨어지므로([context.py](../modules/context.py#L150)) 추천은 항상 동작합니다.
