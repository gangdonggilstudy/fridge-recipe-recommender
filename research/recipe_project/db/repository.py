from db.connection import DB_DIALECT

if DB_DIALECT == "sqlite":
    from db.repository_sqlite import *
elif DB_DIALECT == "mysql":
    from db.repository_mysql import *
else:
...
#     recipe.setdefault("recipe_id", "")
#     recipe.setdefault("title", "")
#     recipe.setdefault("category_type", "")
#     recipe.setdefault("summary", "")
#     recipe.setdefault("ingredients", "")
#     recipe.setdefault("steps", "")
#     recipe.setdefault("tags", "")
#     recipe.setdefault("cook_time", None)
#     recipe.setdefault("difficulty", "")
#     recipe.setdefault("avg_rating", None)
#     recipe.setdefault("view_count", 0)
#     recipe.setdefault("scrap_count", 0)
#     recipe.setdefault("review_count", 0)
...
#         SELECT COUNT(*) AS recipe_count
#           FROM raw_recipe
#           WHERE (',' || COALESCE(category_types, '') || ',') LIKE '%,' || :collect_value || ',%'
#     """)
